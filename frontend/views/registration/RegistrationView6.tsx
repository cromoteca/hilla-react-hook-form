...
export default function RegistrationView6() {
    const countries = [
    ...
    return (
        <VerticalLayout className='p-m'>
            <p>
                This example adds an endpoint call to perform real-time server-side validation. Try
                simulating a network delay with the browser dev tools to see how it kicks in after
