...
/**
 * This resolver simulates what could be generated by Hilla.
 * 
 * It contains a sequence of simple checks that mimic most of the checks that happen in the backend.
 */
export const RegistrationInfoResolver: Resolver<RegistrationInfo, any> = async (values, _context, _options) => {
    const errors: any = {};
